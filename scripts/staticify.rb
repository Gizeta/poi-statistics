...
def staticify_wiki_drop(map_id, drop_pool_name)
  ...
  KanColleConstant.map[map_id][:cells].sort { |x, y| x[:point] <=> y[:point] }.each do |cell|
    drop_list = DropShipStatistic.where(
      ...
      next if x == 0
      if x == 486 || x == 516 || x == 561 || x == 596 || x == 625 || x == 653 || x == 520
        "驱逐舰"
      elsif x == 574 || x == 604 || x == 615 || x == 613 || x == 590 || x == 514
        "轻巡洋舰"
      elsif x == 449 || x == 448 || x == 595
        "重巡洋舰"
      elsif x == 423 || x == 473 || x == 457 || x == 471 || x == 472 || x == 456 || x == 452 || x == 485 || x == 481 || x == 480 || x == 479 || x == 475 || x == 519 || x == 474 || x == 484 || x == 527 || x == 528 || x == 532 || x == 562 || x == 614 || x == 583 || x == 632
        "驱逐舰"
      elsif x == 483 || x == 494 || x == 162 || x == 517 || x == 518 || x == 524 || x == 491 || x == 525 || x == 535 || x == 540 || x == 493 || x == 552 || x == 531 || x == 551 || x == 565 || x == 495 || x == 585 || x == 611 || x == 584 || x == 570 || x == 634 || x == 637 || x == 612 || x == 581 || x == 621
        "其他"
      elsif x == 444 || x == 521 || x == 515 || x == 433 || x == 534 || x == 544 || x == 549
        "空母类"
      elsif x == 439 || x == 492 || x == 511 || x == 440 || x == 571 || x == 601
        "战列舰"
      else
    ...
    ["驱逐舰", "轻巡洋舰", "重巡洋舰", "战列舰", "空母类", "其他"].each do |type|
      ...
      r += (drop_list[type].map do |i|
        ...
        info = case i
          when 486, 452, 423, 473, 457, 471, 472, 456, 449, 485, 481, 483, 494, 480, 479, 491, 444, 448, 525, 535, 439, 475, 492, 515, 519, 552, 474, 484, 531, 511, 516, 433, 440, 527, 551, 574, 565, 495, 528, 532, 562, 585, 534, 544, 561, 596, 549, 611, 614, 583, 584, 604, 595, 570, 625, 634, 637, 615, 613, 632, 612, 581, 590, 653
            ship
          when 520, 514, 571, 601, 621
            ship
          else
    ...
    KanColleConstant.map[map_id][:cells].sort { |x, y| x[:point] <=> y[:point] }.each do |cell|
      ...
      DropShipStatistic.where(
        ...
        if (sum > 1000 && q["value"]["count"].to_f / sum > 0.001) || sum <= 1000
          ...
          count += 1
        else p cell[:point]; p sum; p q["value"]["count"]; p q["_id"]         end
      end
      result += "}}<br/>"
...
pool = { map: [501, 502, 503], name: "test" }
