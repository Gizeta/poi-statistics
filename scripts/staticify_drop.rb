...
$event_maps = [511, 512, 513]

def staticify_drop_map(map_id)
  levels = map_id > 100 ? [4, 3, 2, 1] : [0]
  table = map_id > 100 ? DropRecordSummer2021 : DropRecord
  table_name = map_id > 100 ? "drop_records_summer2021" : "drop_records"
...
def staticify_drop_ship()
  table = [DropRecord, DropRecordSummer2021]
  table_name = ["drop_records", "drop_records_summer2021"]
