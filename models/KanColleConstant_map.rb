...
class KanColleConstant
  ...
  @@map = {
    ...
    485 => {
      :name => @data.find { |x| x["id"] == 485 }["name"],
      :map => @data.find { |x| x["id"] == 485 }["image"],
      :cells => @data.find { |x| x["id"] == 485 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    486 => {
      :name => @data.find { |x| x["id"] == 486 }["name"],
      :map => @data.find { |x| x["id"] == 486 }["image"],
      :cells => @data.find { |x| x["id"] == 486 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    487 => {
      :name => @data.find { |x| x["id"] == 487 }["name"],
      :map => @data.find { |x| x["id"] == 487 }["image"],
      :cells => @data.find { |x| x["id"] == 487 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    491 => {
      :name => @data.find { |x| x["id"] == 491 }["name"],
      :map => @data.find { |x| x["id"] == 491 }["image"],
      :cells => @data.find { |x| x["id"] == 491 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    492 => {
      :name => @data.find { |x| x["id"] == 492 }["name"],
      :map => @data.find { |x| x["id"] == 492 }["image"],
      :cells => @data.find { |x| x["id"] == 492 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    493 => {
      :name => @data.find { |x| x["id"] == 493 }["name"],
      :map => @data.find { |x| x["id"] == 493 }["image"],
      :cells => @data.find { |x| x["id"] == 493 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    494 => {
      :name => @data.find { |x| x["id"] == 494 }["name"],
      :map => @data.find { |x| x["id"] == 494 }["image"],
      :cells => @data.find { |x| x["id"] == 494 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    73 => {
      :name => @data.find { |x| x["id"] == 73 }["name"],
      :map => @data.find { |x| x["id"] == 73 }["image"],
      :cells => @data.find { |x| x["id"] == 73 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    501 => {
      :name => @data.find { |x| x["id"] == 501 }["name"],
      :map => @data.find { |x| x["id"] == 501 }["image"],
      :cells => @data.find { |x| x["id"] == 501 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    502 => {
      :name => @data.find { |x| x["id"] == 502 }["name"],
      :map => @data.find { |x| x["id"] == 502 }["image"],
      :cells => @data.find { |x| x["id"] == 502 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    503 => {
      :name => @data.find { |x| x["id"] == 503 }["name"],
      :map => @data.find { |x| x["id"] == 503 }["image"],
      :cells => @data.find { |x| x["id"] == 503 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    504 => {
      :name => @data.find { |x| x["id"] == 504 }["name"],
      :map => @data.find { |x| x["id"] == 504 }["image"],
      :cells => @data.find { |x| x["id"] == 504 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    505 => {
      :name => @data.find { |x| x["id"] == 505 }["name"],
      :map => @data.find { |x| x["id"] == 505 }["image"],
      :cells => @data.find { |x| x["id"] == 505 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    511 => {
      :name => @data.find { |x| x["id"] == 511 }["name"],
      :map => @data.find { |x| x["id"] == 511 }["image"],
      :cells => @data.find { |x| x["id"] == 511 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    512 => {
      :name => @data.find { |x| x["id"] == 512 }["name"],
      :map => @data.find { |x| x["id"] == 512 }["image"],
      :cells => @data.find { |x| x["id"] == 512 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    513 => {
      :name => @data.find { |x| x["id"] == 513 }["name"],
      :map => @data.find { |x| x["id"] == 513 }["image"],
      :cells => @data.find { |x| x["id"] == 513 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    521 => {
      :name => @data.find { |x| x["id"] == 521 }["name"],
      :map => @data.find { |x| x["id"] == 521 }["image"],
      :cells => @data.find { |x| x["id"] == 521 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    522 => {
      :name => @data.find { |x| x["id"] == 522 }["name"],
      :map => @data.find { |x| x["id"] == 522 }["image"],
      :cells => @data.find { |x| x["id"] == 522 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    523 => {
      :name => @data.find { |x| x["id"] == 523 }["name"],
      :map => @data.find { |x| x["id"] == 523 }["image"],
      :cells => @data.find { |x| x["id"] == 523 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    531 => {
      :name => @data.find { |x| x["id"] == 531 }["name"],
      :map => @data.find { |x| x["id"] == 531 }["image"],
      :cells => @data.find { |x| x["id"] == 531 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    532 => {
      :name => @data.find { |x| x["id"] == 532 }["name"],
      :map => @data.find { |x| x["id"] == 532 }["image"],
      :cells => @data.find { |x| x["id"] == 532 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    533 => {
      :name => @data.find { |x| x["id"] == 533 }["name"],
      :map => @data.find { |x| x["id"] == 533 }["image"],
      :cells => @data.find { |x| x["id"] == 533 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    74 => {
      :name => @data.find { |x| x["id"] == 74 }["name"],
      :map => @data.find { |x| x["id"] == 74 }["image"],
      :cells => @data.find { |x| x["id"] == 74 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    554 => {
      :name => @data.find { |x| x["id"] == 554 }["name"],
      :map => @data.find { |x| x["id"] == 554 }["image"],
      :cells => @data.find { |x| x["id"] == 554 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    555 => {
      :name => @data.find { |x| x["id"] == 555 }["name"],
      :map => @data.find { |x| x["id"] == 555 }["image"],
      :cells => @data.find { |x| x["id"] == 555 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    556 => {
      :name => @data.find { |x| x["id"] == 556 }["name"],
      :map => @data.find { |x| x["id"] == 556 }["image"],
      :cells => @data.find { |x| x["id"] == 556 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    75 => {
      :name => @data.find { |x| x["id"] == 75 }["name"],
      :map => @data.find { |x| x["id"] == 75 }["image"],
      :cells => @data.find { |x| x["id"] == 75 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    561 => {
      :name => @data.find { |x| x["id"] == 561 }["name"],
      :map => @data.find { |x| x["id"] == 561 }["image"],
      :cells => @data.find { |x| x["id"] == 561 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    562 => {
      :name => @data.find { |x| x["id"] == 562 }["name"],
      :map => @data.find { |x| x["id"] == 562 }["image"],
      :cells => @data.find { |x| x["id"] == 562 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    563 => {
      :name => @data.find { |x| x["id"] == 563 }["name"],
      :map => @data.find { |x| x["id"] == 563 }["image"],
      :cells => @data.find { |x| x["id"] == 563 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    564 => {
      :name => @data.find { |x| x["id"] == 564 }["name"],
      :map => @data.find { |x| x["id"] == 564 }["image"],
      :cells => @data.find { |x| x["id"] == 564 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    565 => {
      :name => @data.find { |x| x["id"] == 565 }["name"],
      :map => @data.find { |x| x["id"] == 565 }["image"],
      :cells => @data.find { |x| x["id"] == 565 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    566 => {
      :name => @data.find { |x| x["id"] == 566 }["name"],
      :map => @data.find { |x| x["id"] == 566 }["image"],
      :cells => @data.find { |x| x["id"] == 566 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    571 => {
      :name => @data.find { |x| x["id"] == 571 }["name"],
      :map => @data.find { |x| x["id"] == 571 }["image"],
      :cells => @data.find { |x| x["id"] == 571 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    572 => {
      :name => @data.find { |x| x["id"] == 572 }["name"],
      :map => @data.find { |x| x["id"] == 572 }["image"],
      :cells => @data.find { |x| x["id"] == 572 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    573 => {
      :name => @data.find { |x| x["id"] == 573 }["name"],
      :map => @data.find { |x| x["id"] == 573 }["image"],
      :cells => @data.find { |x| x["id"] == 573 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    574 => {
      :name => @data.find { |x| x["id"] == 574 }["name"],
      :map => @data.find { |x| x["id"] == 574 }["image"],
      :cells => @data.find { |x| x["id"] == 574 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    575 => {
      :name => @data.find { |x| x["id"] == 575 }["name"],
      :map => @data.find { |x| x["id"] == 575 }["image"],
      :cells => @data.find { |x| x["id"] == 575 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    576 => {
      :name => @data.find { |x| x["id"] == 576 }["name"],
      :map => @data.find { |x| x["id"] == 576 }["image"],
      :cells => @data.find { |x| x["id"] == 576 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    577 => {
      :name => @data.find { |x| x["id"] == 577 }["name"],
      :map => @data.find { |x| x["id"] == 577 }["image"],
      :cells => @data.find { |x| x["id"] == 577 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    581 => {
      :name => @data.find { |x| x["id"] == 581 }["name"],
      :map => @data.find { |x| x["id"] == 581 }["image"],
      :cells => @data.find { |x| x["id"] == 581 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    582 => {
      :name => @data.find { |x| x["id"] == 582 }["name"],
      :map => @data.find { |x| x["id"] == 582 }["image"],
      :cells => @data.find { |x| x["id"] == 582 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    583 => {
      :name => @data.find { |x| x["id"] == 583 }["name"],
      :map => @data.find { |x| x["id"] == 583 }["image"],
      :cells => @data.find { |x| x["id"] == 583 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    584 => {
      :name => @data.find { |x| x["id"] == 584 }["name"],
      :map => @data.find { |x| x["id"] == 584 }["image"],
      :cells => @data.find { |x| x["id"] == 584 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    591 => {
      :name => @data.find { |x| x["id"] == 591 }["name"],
      :map => @data.find { |x| x["id"] == 591 }["image"],
      :cells => @data.find { |x| x["id"] == 591 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    592 => {
      :name => @data.find { |x| x["id"] == 592 }["name"],
      :map => @data.find { |x| x["id"] == 592 }["image"],
      :cells => @data.find { |x| x["id"] == 592 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    593 => {
      :name => @data.find { |x| x["id"] == 593 }["name"],
      :map => @data.find { |x| x["id"] == 593 }["image"],
      :cells => @data.find { |x| x["id"] == 593 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    594 => {
      :name => @data.find { |x| x["id"] == 594 }["name"],
      :map => @data.find { |x| x["id"] == 594 }["image"],
      :cells => @data.find { |x| x["id"] == 594 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    595 => {
      :name => @data.find { |x| x["id"] == 595 }["name"],
      :map => @data.find { |x| x["id"] == 595 }["image"],
      :cells => @data.find { |x| x["id"] == 595 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    601 => {
      :name => @data.find { |x| x["id"] == 601 }["name"],
      :map => @data.find { |x| x["id"] == 601 }["image"],
      :cells => @data.find { |x| x["id"] == 601 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    602 => {
      :name => @data.find { |x| x["id"] == 602 }["name"],
      :map => @data.find { |x| x["id"] == 602 }["image"],
      :cells => @data.find { |x| x["id"] == 602 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    603 => {
      :name => @data.find { |x| x["id"] == 603 }["name"],
      :map => @data.find { |x| x["id"] == 603 }["image"],
      :cells => @data.find { |x| x["id"] == 603 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    604 => {
      :name => @data.find { |x| x["id"] == 604 }["name"],
      :map => @data.find { |x| x["id"] == 604 }["image"],
      :cells => @data.find { |x| x["id"] == 604 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    605 => {
      :name => @data.find { |x| x["id"] == 605 }["name"],
      :map => @data.find { |x| x["id"] == 605 }["image"],
      :cells => @data.find { |x| x["id"] == 605 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    606 => {
      :name => @data.find { |x| x["id"] == 606 }["name"],
      :map => @data.find { |x| x["id"] == 606 }["image"],
      :cells => @data.find { |x| x["id"] == 606 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    611 => {
      :name => @data.find { |x| x["id"] == 611 }["name"],
      :map => @data.find { |x| x["id"] == 611 }["image"],
      :cells => @data.find { |x| x["id"] == 611 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    612 => {
      :name => @data.find { |x| x["id"] == 612 }["name"],
      :map => @data.find { |x| x["id"] == 612 }["image"],
      :cells => @data.find { |x| x["id"] == 612 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    613 => {
      :name => @data.find { |x| x["id"] == 613 }["name"],
      :map => @data.find { |x| x["id"] == 613 }["image"],
      :cells => @data.find { |x| x["id"] == 613 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    614 => {
      :name => @data.find { |x| x["id"] == 614 }["name"],
      :map => @data.find { |x| x["id"] == 614 }["image"],
      :cells => @data.find { |x| x["id"] == 614 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
    ...
    615 => {
      :name => @data.find { |x| x["id"] == 615 }["name"],
      :map => @data.find { |x| x["id"] == 615 }["image"],
      :cells => @data.find { |x| x["id"] == 615 }["cells"].filter { |x, y| y["name"] != nil }.map do |x, y|
        {
          :name => y["name"],
          :point => x.to_sym,
          :boss => y["boss"],
