class KCConstants
  ...
  @@cells = {
    ...
    321 => {
      ...
      6 => '空母機動部隊(E1-F)',
      8 => '水上打撃部隊(E1-H)',
      10 => '前衛展開部隊旗艦(E1-J)(Boss)',
      11 => '前衛哨戒部隊(E1-C)',
      12 => '空母機動部隊(E1-F)',
      13 => '水上打撃部隊(E1-H)',
      14 => '前衛展開部隊旗艦(E1-J)(Boss)',
    },
    322 => {
      2 => '警戒任務群 前衛別働隊(E2-B)',
      3 => '警戒任務群 重巡戦隊(E2-C)',
      ...
      7 => '警戒任務群 主力部隊増援(E2-H)',
      8 => 'バニラ湾輸送部隊(E2-G)',
      11 => '警戒任務群 旗艦艦隊(E2-K)(Boss)',
      12 => '潜水艦警戒線(E2-E)',
      13 => '警戒任務群 主力部隊(E2-F)',
      14 => '警戒任務群 主力部隊(E2-F)',
      17 => '警戒任務群 旗艦艦隊(E2-K)(Boss)',
    },
    323 => {
      2 => '深海潜水艦隊(E3-B)',
      3 => '前衛警戒部隊(E3-C)',
    ...
    324 => {
      ...
      10 => '復旧中港湾施設(E4-J)',
      13 => '再建中秘匿泊地(E4-M)',
      14 => '増援東洋艦隊 前衛潜水艦隊(E4-N)',
      15 => '東洋艦隊 増援部隊 司令旗艦(E4-O)(Boss)',
      17 => '空母機動部隊 II群(E4-F)',
      18 => '空母機動部隊 I群(E4-I)',
    },
    325 => {
      2 => '潜水艦阻止線 Aライン哨戒前衛(E5-B)',
      4 => '潜水艦阻止線 Aライン(E5-D)',
      6 => '潜水艦阻止線 Bライン(E5-F)',
      7 => '輸送部隊迎撃部隊 前衛哨戒艦隊(E5-G)',
      8 => '高速魚雷艇部隊(E5-H)',
      9 => '伏撃部隊 軽巡戦隊(E5-I)',
      10 => '伏撃部隊 精鋭駆逐隊(E5-J)',
      12 => '深海補給船団(E5-L)',
      14 => '伏撃部隊集団 旗艦(E5-N)(Boss)',
      17 => '輸送部隊迎撃部隊 前衛哨戒艦隊(E5-G)',
      18 => '伏撃部隊 精鋭駆逐隊(E5-J)',
      19 => '伏撃部隊 精鋭駆逐隊(E5-J)',
    },
  }
...
=end
  ...
  class Internal
    def [](index)
      if KCConstants.ship_infos0[index].nil?
        ship = ConstData.ship[index]
        return {
          :chinese_name => ship["chinese_name"],
          :ship_type => ConstData.shiptype[ship["stype"]]["english_name"].downcase,
          :rare => true,
        }
      else
        return KCConstants.ship_infos0[index]
      end
    end
  end
